...
export function collectInterpretationContext(
  ...
  return {
    ...
    paragraph,
    previousParagraph: siblingParagraph(paragraphElement, "previous") || undefined,
    nextParagraph: siblingParagraph(paragraphElement, "next") || undefined,
    nearestHeading: nearestHeading(paragraphElement) || undefined,
