...
const instructions = `Explain the selected foreign-language expression to a reader in the requested target language.
  ...
  return {
    ...
    async interpret(context, { signal } = {}) {
      const request = {
        ...
        signal,
        body: JSON.stringify({ model, instructions, input: JSON.stringify(context), max_output_tokens: 300,
