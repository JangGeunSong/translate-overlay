...
See [docs/PROJECT_OVERVIEW.md](docs/PROJECT_OVERVIEW.md), the [Phase 3 packet](docs/tasks/0003-semantic-priority-and-interpretation.md), and the [Phase 4 packet](docs/tasks/0004-production-e2e-and-public-qa.md).
